...
$arrayofparameters = array(
	'LINESFROMPRODUCTMATRIX_MYPARAM1'=>array('css'=>'minwidth200', 'enabled'=>1),
	'LINESFROMPRODUCTMATRIX_MYPARAM2'=>array('css'=>'minwidth500', 'enabled'=>1)
);
...
} elseif ($action == 'specimen')
{
	...
	{
		$file = dol_buildpath($reldir."core/modules/linesfromproductmatrix/doc/pdf_".$modele."_".strtolower($tmpobjectkey).".modules.php", 0);
		if (file_exists($file))
		{
			$filefound = 1;
...
} elseif ($action == 'setmod')
{
	...
	$tmpobjectkey = GETPOST('object');
	$constforval = 'LINESFROMPRODUCTMATRIX_'.strtoupper($tmpobjectkey)."_ADDON";
					...
					while (($file = readdir($handle)) !== false)
					{
						if (strpos($file, 'mod_'.strtolower($myTmpObjectKey).'_') === 0 && substr($file, dol_strlen($file) - 3, 3) == 'php')
						{
							...
							if ($module->isEnabled())
							{
								...
								$constforvar = 'LINESFROMPRODUCTMATRIX_'.strtoupper($myTmpObjectKey).'_ADDON';
