...
/**
 *	\file       linesfromproductmatrix/linesfromproductmatrixindex.php
 *	\ingroup    linesfromproductmatrix
 *	\brief      Home page of linesfromproductmatrix top menu
 */
...
// Draft MyObject
if (! empty($conf->linesfromproductmatrix->enabled) && $user->rights->linesfromproductmatrix->read)
{
	$langs->load("orders");
