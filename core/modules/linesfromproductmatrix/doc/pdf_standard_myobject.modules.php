...
/**
 *  \file       linesfromproductmatrix/core/modules/linesfromproductmatrix/doc/pdf_standard.modules.php
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->linesfromproductmatrix->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->linesfromproductmatrix->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->linesfromproductmatrix->dir_output.'/myobject/'.$objectref;
