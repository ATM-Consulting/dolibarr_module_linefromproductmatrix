...
ALTER TABLE llx_linesfromproductmatrix_bloc ADD INDEX idx_linesfromproductmatrix_bloc_fk_soc (fk_soc);
ALTER TABLE llx_linesfromproductmatrix_bloc ADD INDEX idx_linesfromproductmatrix_bloc_fk_project (fk_project);
