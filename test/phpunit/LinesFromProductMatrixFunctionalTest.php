...
/**
 * \file    test/phpunit/LinesFromProductMatrixFunctionalTest.php
...
/**
 * Class LinesFromProductMatrixFunctionalTest
 *
 ...
 *
 * @package Testlinesfromproductmatrix
 */
class LinesFromProductMatrixFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modLinesFromProductMatrix')->click();
		} else {
			// Disable the module
			$this->byHref('modLinesFromProductMatrix')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/linesfromproductmatrix/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('linesfromproductmatrix/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/linesfromproductmatrix/admin/about.php');
		$this->authenticate();
		return $this->assertContains('linesfromproductmatrix/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('linesfromproductmatrixwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modLinesFromProductMatrix_LinesFromProductMatrixTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modLinesFromProductMatrix_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
